...
const STONES = [
  ...
  },
  {
    ...
    progenitor: {
      ...
      shards: 10,
      effect: [
        "Summon a 1ft. Cube of pure tungsten from the Dense Dimension to perform one of the following actions:",
        "Crush — Summon the cube directly above the head of a creature that you can see and send it crashing down upon it. Have the creature make a Dexterity (DEX) or Strength (STR) saving throw or take 50 (11d8) Bludgeoing damage or half as much on a success. A creature that fails this save by 5 or more loses its action on its next turn. A creature that succeeds by 5 or more takes 0 damage from this attack.",
        "Unmoveable — Summon this cube from thin air. You may place this cube in any open place that you see within 20ft. of you, that could logically have space for it. You command the cube to maintain its position in space for the next hour, regardless of gravity. Afterwards, the cube is dismissed back to the Dense Dimension. This cube may be moved 10ft. by succeeding a DC 30 Athletics (STR) check.",
        "Ballistic — Send the cube rocketing from you forward in a straight line. Tungsten Ballistic. Ranged Attack, plus Stonekeeper attack modifier to hit, reach 60 ft., one target. Hit: 26 (4d12) plus your Charisma (CHA) modifier. If the target creature is size Large or smaller, it is sent to the very end of the 60ft. line of this attack, crashing through all creatures within. The target creature takes 5 additional Bludgeoing damage for each creature it crashes through, stopping if it hits a wall or other structure.",
		"ElectricalConductivity — Summon the cube in an open space next to you for the next minute. For the duration, any and all attacks or effects in a 100ft. area around the cube that would deal Lightning damage are nullified and targeted on the cube instead. This cube has 50 HP and will last until either the minute is up or until it is destroyed.",
		"Note that this only applies to the Lightning damage of any particular attack or effect. For instance, an enchanted sword strike dealing 1d8 Slashing damage and 1d6 Lightning damage will still hit its target, only sending the 1d6 Lightning damage to the cube.",
		"️After any effect has taken place, your speed is reduced to 0 for the next minute.",
      ],
    },
    fused: {
      shardsToCreate: 16,
      action: "Passive",
      effect: [
        "The Dense Dimension is vast and unknowable. When you fuse together 16 Shards, you create a permanent 6-inch Tungsten cube from the Dense Dimension that weighs 140lbs. This cube is so heavy and so dense that it looks to have its own gravitational field, pulling any small, loose objects weighing 5 oz or less to itself.",
        "You must be able to lift this stone in order to trigger it. It requires two hands to use and cannot be made into jewelry. When held, this cube turns you into solid Tungsten.",
        "While holding this cube, you gain the following effects:",
        "Resistance — You gain resistance to Lightning, Force, Fire, Acid, Bludgeoning, Piercing and Slashing damage.",
		"Ballistics — You are able to attack with Tungsten Ballistic freely once per turn.",
		"UnstoppableForce — (Recharge on 5-6) You can use an action to move forward twice your movement speed in a straight line. This movement is unavoidable, and you will smash through all creatures, objects,s and structures up to 10ft. thick. Any creature caught in this line must make a Dexterity (DEX) saving throw or take 33 (6d10) Bludgeoning damage or half as much on a successful save. After which, all creatures are thrown 10ft. and knocked Prone.",
        "ImmovableObject — You are unable to be grappled, pushed, thrown, displaced, or otherwise moved against your will. This effect also applies to spells like Hold Person, Banishment, or Reverse Gravity.",
		"ReverseFeatherfall — You lose any ability to jump, float, or fly. If you happen to fall from a great height, you fall 1000ft. per round rather than 500ft. Additionally, when calculating fall damage, you take 1d20 Bludgeoning damage for every 10 feet fallen rather than 1d6 (to a maximum of 20d20).",
		"SpeedReduction — Your Speed is halved, and you can no longer take the Dash Action or climb.",
		"DimensionExpansion — Density Superiority. Using an action, you summon the Dense Dimension into the Material Plane.",
		"For the next minute, a 30ft. cube surrounds you, creating an impenetrable wall on all sides. Any creatures caught inside (other than you) with a Strenth (STR) score of less than 22, immediately fail all rolls that involve Strength (STR) or Dexterity (DEX). Additionally, you are able to freely attack with Tungsten Ballistic without making an attack roll.",
		"Afterwards, your speed is reduced to 0 for the next minute, and this ability goes on a 7-day cooldown.",
      ],
    },
  },
];
