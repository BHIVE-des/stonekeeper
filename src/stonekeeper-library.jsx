  ...
  },
  {
    ...
    progenitor: {
      ...
      effect: [
		...
		"️⚠️ After any effect has taken place, your speed is reduced to 0 for the next minute.",
      ],
    },
    fused: {
      shardsToCreate: 16,
      ...
      effect: [
        ...
        "— You gain resistance to Lightning, Force, Fire, Acid, Bludgeoning, Piercing and Slashing damage.",
		"— You are able to attack with Tungsten Ballistic freely once per turn.",
		"— Unstoppable Force. (Recharge on 5-6) You can use an action to move forward twice your movement speed in a straight line. This movement is unavoidable, and you will smash through all creatures, objects,s and structures up to 10ft. thick. Any creature caught in this line must make a Dexterity (DEX) saving throw or take 33 (6d10) Bludgeoning damage or half as much on a successful save. After which, all creatures are thrown 10ft. and knocked Prone.",
        "— Immovable Object. You are unable to be grappled, pushed, thrown, displaced, or otherwise moved against your will. This effect also applies to spells like Hold Person, Banishment, or Reverse Gravity.",
		"— Reverse Featherfall. You lose any ability to jump, float, or fly. If you happen to fall from a great height, you fall 1000ft. per round rather than 500ft. Additionally, when calculating fall damage, you take 1d20 Bludgeoning damage for every 10 feet fallen rather than 1d6 (to a maximum of 20d20).",
		"— Your Speed is halved, and you can no longer take the Dash Action or climb.",
		"— Dimension Expansion, Density Superiority. Using an action, you summon the Dense Dimension into the Material Plane.",
		...
		"⚠️ Afterwards, your speed is reduced to 0 for the next minute, and this ability goes on a 7-day cooldown.",
      ],
    },
  },
];
